        ...
        <!-- header logo: style can be found in header.less -->
            <header class="header">
                <a href="<?=Url::home() ?>" class="logo">
                    ...
                    <div class='cis-text cis-logo'>
                        CIS
                    </div>
                    <div class='cis-text'>
                        INSTITUT <br> TEKNOLOGI DEL
                    </div>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            <?php if (!\Yii::$app->user->isGuest): ?>
                                ...
                                <?php
                                    ...
                                    $notifData = \Yii::$app->messenger->getMyNotificationsData(['limit' => 100]);
                                ...
                                <li class="dropdown notifications-menu">
                                    <a id='notif-button' goto="<?=Url::toRoute(['/api/notification/setallseen']) ?>" href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <?php else: ?>
                                            <?php if (isset($notifInfo->info) && $notifInfo->info->unread > 0): ?>
                                                <span id='notif-banner' class="label label-warning"><?=$notifInfo->info->unread ?></span>
                                            <?php endif ?>
                                        <?php endif ?>
                                    </a>
